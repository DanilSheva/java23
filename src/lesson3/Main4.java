        ...
        switch (inputFigura) {
            case 1:
                ...
                if (inputRadiusOrDiameter == 1) {
                    ...
                    System.out.println("Периметр круга = "+(2*Math.PI*inputRadiusOrDiameter) );
                }
                break;
            ...
            case 2:
                ...
                System.out.println("Введите малую поуось овала");
            ...
            case 4:
                ...
                if (inputAction == 1) {
                    ...
                    System.out.println("Площадь треугольника = " + (Math.sqrt(pPerimetr * (pPerimetr - inputSideA)
                            * (pPerimetr - inputSideB) * (pPerimetr - inputSideC))));
                } else {
            ...
            case 5:
                ...
                if (inputAction==1){
                    ...
                    System.out.println("Пириметр трапеции =" +(sideA+sideB+sideC+sideD));
                }
